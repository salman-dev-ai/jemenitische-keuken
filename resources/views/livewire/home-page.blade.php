...
<div class="space-y-0 text-right font-['Tajawal',sans-serif]" dir="{{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}">
    ...
    {{-- 1. HERO SECTION--}}
    <section id="home" class="relative min-h-[92svh] flex items-center justify-center bg-gradient-to-b from-[#240B08] via-[#1D0806] to-[#2B0E0A] text-white py-20 px-4 sm:px-6 lg:px-8 overflow-hidden border-b border-[#E07513]/30">
        ...
        <div class="max-w-5xl mx-auto text-center relative z-10 space-y-7">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
                ...
                <a href="#menu_with_cart" class="w-full sm:w-auto px-8 py-4 bg-white/10 hover:bg-white/15 text-white font-bold rounded-2xl border border-white/25 hover:border-white/45 transition-all flex items-center justify-center gap-3 text-base backdrop-blur-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FFD700]">
